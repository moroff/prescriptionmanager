INSERT INTO drugs (id, name, package_size, pzn) VALUES (1, "Thyronajod 75 Henning", 100, "") ON CONFLICT DO NOTHING;
INSERT INTO drugs (id, name, package_size, pzn) VALUES (2, "Thyronajod 100 Henning") ON CONFLICT DO NOTHING;
INSERT INTO drugs (id, name, package_size, pzn) VALUES (3, "Aspirin Plus C", 10, "1406632") ON CONFLICT DO NOTHING;

INSERT INTO drugs (id, name, package_size, pzn) VALUES (4, "DIGIMERCK MINOR 0.07, TAB", 100, "") ON CONFLICT DO NOTHING;
INSERT INTO drugs (id, name, package_size, pzn) VALUES (5, "ESCITALOPRAM ABZ 10MG, FTA", 100, "") ON CONFLICT DO NOTHING;
INSERT INTO drugs (id, name, package_size, pzn) VALUES (6, "AMLODIPIN AAA 5MG TABL, TAB", 100, "") ON CONFLICT DO NOTHING;
INSERT INTO drugs (id, name, package_size, pzn) VALUES (7, "RAMILICH 5MG TABLETTEN, TAB", 100, "") ON CONFLICT DO NOTHING;
INSERT INTO drugs (id, name, package_size, pzn) VALUES (8, "METOHEXA-SUCC 47.5MG, RET", 100, "") ON CONFLICT DO NOTHING;
INSERT INTO drugs (id, name, package_size, pzn) VALUES (9, "HCT DEXCEL 25MG, TAB", 100, "") ON CONFLICT DO NOTHING;

INSERT INTO drugs (id, name, package_size, pzn) VALUES (10, "L. THYROXIN WINTHROP 150UG, TAB", 100, "") ON CONFLICT DO NOTHING;
INSERT INTO drugs (id, name, package_size, pzn) VALUES (11, "VALSACOR COP 80/12.5MG, FTA", 100, "") ON CONFLICT DO NOTHING;
INSERT INTO drugs (id, name, package_size, pzn) VALUES (12, "TORASEMID AL 10MG TABL, TAB", 100, "") ON CONFLICT DO NOTHING;
INSERT INTO drugs (id, name, package_size, pzn) VALUES (13, "PRADAXA 110MG, HKP", 100, "") ON CONFLICT DO NOTHING;
INSERT INTO drugs (id, name, package_size, pzn) VALUES (14, "PROCORALAN 5MG FILMTABL, FTA", 100, "") ON CONFLICT DO NOTHING;
