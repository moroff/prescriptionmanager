INSERT INTO drugs (id, name, package_size) VALUES (1, "Thyronajod 75 Henning", 100) ON CONFLICT DO NOTHING;
INSERT INTO drugs (id, name, package_size) VALUES (2, "Thyronajod 100 Henning") ON CONFLICT DO NOTHING;
